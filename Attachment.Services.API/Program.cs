...
using Attachment.Services.API.Infrastructure;

namespace Attachment.Services.API
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            UploadPaths.Configure(builder.Configuration);
            ...
            var customFileProvider = app.Services.GetRequiredService<CustomFileProvider>();
            ...
            {
                options.WithTitle("Attachment Microservice API")
