...
{
    public class ShowCertificationQueryHandler : IRequestHandler<ShowCertificationQuery, Result<CertificationDto>>
    {
        private readonly IUnitOfWork _unitOfWork;

        public ShowCertificationQueryHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<Result<CertificationDto>> Handle(ShowCertificationQuery request, CancellationToken cancellationToken)
        {
