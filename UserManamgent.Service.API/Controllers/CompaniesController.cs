...
namespace UserManamgent.Service.API.Controllers
{
    ...
    public class CompaniesController : AppControllerBase
    {
        ...
        [HttpGet][Route(UserManagementApiRoutes.Companies.GetProducts)][AllowAnonymous] public async Task<IActionResult> GetProducts([FromRoute] Guid companyId, [FromQuery] GetCompanyProductsQuery q, CancellationToken ct) { q.CompanyId = companyId; return ToActionResult(await _mediator.Send(q, ct)); }
