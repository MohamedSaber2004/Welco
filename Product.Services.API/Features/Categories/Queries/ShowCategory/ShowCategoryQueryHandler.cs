...
{
    public class ShowCategoryQueryHandler : IRequestHandler<ShowCategoryQuery, Result<CategoryDto>>
    {
        private readonly IUnitOfWork _unitOfWork;

        public ShowCategoryQueryHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<Result<CategoryDto>> Handle(ShowCategoryQuery request, CancellationToken cancellationToken)
        {
